...
export default defineConfig({
  ...
  shortcuts: {
    'h-btn': 'h-48px w-100% bg-#5C33BE b-none text-white text-18px rounded-8px px-12px',
    'h-input-text': 'h-48px px-16px leading-32px py-8px b-#5C33BE b-1 b-solid focus:shadow focus:shadow-inset rounded-8px text-18px',
